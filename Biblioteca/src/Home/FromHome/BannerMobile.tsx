    ...
    return(
        <section className="w-full flex lg:hidden pt-10 bg-[url(https://i.postimg.cc/9XsDnh92/Banner.png)] bg-cover bg-top-5 items-center px-10">
            <div className="flex flex-col gap-5 pb-10">
                <h1 className="text-2xl w-55 font-bold" style={{textShadow: "5px 2px 4px #bbbbbb"}}>Explore a world of knowledge without leaving home</h1>
                <p className="text-[.8em] w-65 text-[#ffffff] font-semibold" style={{textShadow: "-1px 1px 2px #727272"}}>Buy and advertise new or used books with ease. Find great stories at low prices.</p>
