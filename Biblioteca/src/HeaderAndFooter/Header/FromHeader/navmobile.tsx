...
const NavFromHeaderMobile= ()=>{
  const {ModalViewMenu}= useContext(DataCostum)
    return(
        <nav className={`flex lg:hidden absolute bg-white ${ModalViewMenu} duration-500 z-10 flex-row w-max py-3 px-2 gap-3 justify-between items-center shadow-2xl rounded-[.5em]`}>
